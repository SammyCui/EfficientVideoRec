...
def _check_params(input: tensor, kernel, stride, dilation, padding):
...
def r_conv2d(in_channels: int,
        out_channels: int,
        kernel_size: _size_2_t,
        inner_stride: _size_2_t = 1,
        outer_stride: _size_2_t = 1,
        padding: Union[str, _size_2_t] = 0,
        dilation: _size_2_t = 1):
    output = torch.empty()


class regional_conv2d(nn.Conv2d):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
        ...
        super().__init__(
            in_channels, out_channels, kernel_size, inner_stride, padding, dilation,
            1, True, 'zeros', device, dtype)
